...
class 通讯(models.Model):
    ...
    图片 = OptimizedImageField(upload_to='images/tongxun/',blank=True,null=True)
...
class 书讯(models.Model):
    ...
    作者 = models.CharField(max_length=200,null=True,blank=True,default="无作者信息")
    图片 = OptimizedImageField(upload_to='images/shuxun/',blank=True,null=True)
    def __str__(self):
        return self.标题
...
class 书评(models.Model):
    ...
    图片 = OptimizedImageField(upload_to='images/shuping/',blank=True,null=True)
    发布状态 = models.BooleanField(default=False)
...
class 观点(models.Model):
    ...
    图片 = OptimizedImageField(upload_to='images/guandian/',blank=True,null=True)
    发布状态 = models.BooleanField(default=False)
...
class 文艺(models.Model):
    ...
    更新时间 = models.DateTimeField(auto_now=True)
    作者 = models.CharField(max_length=200,  null=True,blank=True)
    图片 = OptimizedImageField(upload_to='images/wenyi/',blank=True,null=True)
    发布状态 = models.BooleanField(default=False)
    def __str__(self):
        return self.标题
...
class 译林(models.Model):
    ...
    图片 = OptimizedImageField(upload_to='images/yiling/', blank=True, null=True)
    发布状态 = models.BooleanField(default=False)
...
class 文摘(models.Model):
    ...
    更新时间 = models.DateTimeField(auto_now=True)
    作者 = models.CharField(max_length=200, null=True, blank=True)
    图片 = OptimizedImageField(upload_to='images/wenzhai/', blank=True, null=True)
...
class 经训(models.Model):
    标题 = models.CharField(max_length=150)
    图片 = OptimizedImageField(upload_to='images/jingxun/', blank=True, null=True)
    更新时间 = models.DateTimeField(auto_now=True)
    发布状态 = models.BooleanField(default=False)
...
class 书库(models.Model):
    ...
    简介 = models.TextField()
    图片 = OptimizedImageField(upload_to='images/shuku/', default='null', null=True)
